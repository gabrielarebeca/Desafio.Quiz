...
function Matematica () {
    resposta = prompt("A soma de dois números pares sempre resulta em um número par. Verdadeiro ou falso? ");
    if (resposta.toLowerCase() === "verdadeiro") {
        console.log("Parabéns!");
        pontuacao++;
    } else {
    ...
    resposta = prompt("Qualquer número elevado à potência zero é igual a um. Verdadeiro ou falso? ");
    if (resposta.toLowerCase() === "verdadeiro") {
        console.log("Parabéns!");
        pontuacao++;
    } else {
    ...
    resposta = prompt("A adição é comutativa, ou seja, a ordem dos números não altera o resultado. Verdadeiro ou falso? ");
    if (resposta.toLowerCase() === "verdadeiro") {
        console.log("Parabéns!");
        pontuacao++;npn
    } else {
...
while (op != 0) {
    op = parseInt(prompt("Qual tema você deseja jogar?  1 - Zoologia  2 - Astronomia  3 - Matemática 0 - Sair "));
    switch (op) {
        case 1:
            Zoologia();
            break;
